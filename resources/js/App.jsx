...
export function App() {
    ...
    return (
        <div className="v2-shell v2-noise relative overflow-x-hidden">
            ...
            <header className="relative z-10 mx-auto flex w-full max-w-6xl flex-wrap items-center justify-between gap-4 px-5 py-5 sm:px-8">
                <a href="/" className="group flex items-center gap-3">
                    ...
                    <span className="text-lg font-bold tracking-tight text-white">otshare</span>
                </a>
            ...
            <main className="relative z-10 mx-auto flex min-h-[calc(100vh-160px)] w-full max-w-6xl flex-1 items-center justify-center px-5 py-8 sm:px-8">
